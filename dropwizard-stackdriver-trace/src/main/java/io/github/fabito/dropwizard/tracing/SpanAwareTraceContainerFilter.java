 ...
 */
public class SpanAwareTraceContainerFilter implements ContainerRequestFilter, ContainerResponseFilter {
  ...
  public SpanAwareTraceContainerFilter() {
    this(new TraceHttpRequestInterceptor(), new TraceHttpResponseInterceptor());
  }

  public SpanAwareTraceContainerFilter(TraceHttpRequestInterceptor requestInterceptor,
